...
def _single_input_model(operator: str, *, output_value: float | None = None) -> bytes:
    input_info = helper.make_tensor_value_info("season", TensorProto.FLOAT, [None, 1])
    ...
    if output_value is None:
        ...
        initializers = [value]
    graph = helper.make_graph(nodes, "adversarial", [input_info], [output_info], initializers)
